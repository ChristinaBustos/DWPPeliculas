<template>
    <div>
        <div style="margin-left: 50px; margin-right: 50px; margin-top: 50px; margin-bottom: 50px;">
            <b-card>
                <b-form draggable @dragstart="handleDragStart" @dragover.prevent @drop="handleDrop">
                    <b-row>
                        <b-col>
                            <label for="">Nombre: *</label>
                            <b-input type="text" v-model="pelicula.name" required
                                placeholder="Nombre de la pelicula"></b-input>
                        </b-col>
                        <b-col>
                            <label for="">Genero: *</label>
                            <b-input type="text" v-model="pelicula.genero" required
                                placeholder="Genero de la pelicula"></b-input>
                        </b-col>
                    </b-row>
                    <b-row>
                        <b-col>
                            <label for="">Fecha de publicación: *</label>
                            <b-form-datepicker v-model="pelicula.publishDate" type="date" class="form-control" required
                                aria-describedby="input-live-help input-live-feedback" />
                        </b-col>
                        <b-col>
                            <label for="">Director: *</label>
                            <b-input type="text" v-model="pelicula.director" required
                                placeholder="Director de la pelicula"></b-input>
                        </b-col>
                    </b-row>
        ...
        <div @dragover.prevent @drop="handleDrop"
            ...
            <b-card>
                <p style="color: grey;" v-if="!isDragging">Arrastra acá para guardar la película</p>
                <p style="color: grey;" v-if="isDragging">Suelta aquí para guardar la película</p>
            </b-card>
        </div>


        <b-row style="margin-left: 50px; margin-right: 50px; margin-top: 50px; margin-bottom: 50px;" class=""
            v-if="data && data.data">
